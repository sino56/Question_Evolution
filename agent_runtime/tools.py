...
TOOL_SPECS: Dict[str, ToolSpec] = {
    ...
    "observe_experiment": ToolSpec("observe_experiment", "1.0", "composite", "agent_observation.schema.json", "agent_observation.schema.json", False, ("experiment_dir",), 60, RetryPolicy(1), ("agent_observation.json",), ("score_decreased", "score_unchanged", "score_increased", "not_applicable", "candidate_invalid", "boundary_candidate_found", "budget_warning", "artifact_missing", "manifest_corrupted", "effective_boundary_found", "judge_instability_detected", "memory_written")),
