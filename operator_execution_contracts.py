...
OPERATOR_EXECUTION_CONTRACTS: Dict[str, OperatorExecutionContract] = {
    ...
    "O11_unobserved_state_attribution": _contract(
        ...
        ("constraint_shortage_not_forced", "name_or_order_swap"),
    ...
    "O12_conjunctive_necessity": _contract(
        ...
        ("x_only_y_only_joint_redundancy_matrix", "name_or_order_swap"),
    ...
    "O13_minimal_disqualifier": _contract(
        ...
        ("local_link_recovery", "alternate_path_preserves_overall_claim", "name_or_order_swap"),
    ),
    "O14_information_closure": _contract(
        "O14_information_closure", "信息闭包校验",
        ("公开事实", "事实来源或受控假设标记", "题内规则"), (),
        "不生成题面；逐项记录事实来源缺口。",
        ("fact_source_trace", "world_consistency", "illegal_rule_check"), generates_question=False,
    ),
    ...
    "O16_close_alternative_normalization": _contract(
        ...
        ("discriminator_ablation", "name_or_order_swap"),
    ...
    "O17_action_vs_fact_threshold": _contract(
        ...
        ("rule_name_version_subject_boundary_single_variable", "rule_name_or_order_swap"),
    ...
    "O18_baseline_scope_mismatch": _contract(
        ...
        ("baseline_name_swap", "irrelevant_statistics_invariance"),
    ),
    "O19_multi_entity_role_binding": _contract(
        ...
        ("entity_name_swap", "decisive_behavior_ownership"),
        requires_live_competitor=True,
    ),
    "O20_multistage_event_breakpoint": _contract(
        ...
        ("repair_breakpoint_changes_answer", "branch_change_no_effect", "order_swap"),
    ),
    "O21_object_provenance_identity": _contract(
        ...
        ("key_transfer_changes_identity", "non_identifying_feature_invariance", "name_or_order_swap"),
        requires_live_competitor=True,
    ),
    "O22_path_topology_reachability": _contract(
        ...
        ("decisive_edge_or_window_changes_reachability", "branch_edge_no_effect", "node_name_swap"),
    ...
    "O23_observation_reliability_conflict": _contract(
        ...
        ("decisive_capture_condition_changes_assessment", "constrained_source_copy_no_gain", "source_name_swap"),
    ),
    "O24_multi_hypothesis_residual_ranking": _contract(
        ...
        ("common_coverage_invariance", "key_residual_changes_ranking", "name_or_order_swap"),
        requires_live_competitor=True,
    ),
    "O25_procedural_invariant_frame": _contract(
        ...
        ("mapping_recovery_changes_result", "record_format_invariance", "order_swap"),
    ),
    "O26_quantitative_threshold_propagation": _contract(
        ...
        ("threshold_triplet_coverage", "irrelevant_number_invariance", "unit_name_swap"),
    ),
    "O27_cross_layer_conclusion_calibration": _contract(
        ...
        ("local_evidence_affects_dependent_layer_only", "irrelevant_fact_ablation", "order_swap"),
    ),
    "O28_multihop_chain_closure": _contract(
        ...
        ("missing_link_changes_closure", "branch_node_no_effect", "node_name_or_order_swap"),
    ),
    "O29_entity_identity_conflict_resolution": _contract(
        ...
        ("decisive_conflict_flip_changes_attribution", "ordinary_similarity_no_automatic_boost", "name_or_order_swap"),
        requires_live_competitor=True,
    ),
    "O30_active_discriminative_observation": _contract(
        ...
        ("non_discriminative_observation_low_value", "candidate_order_swap", "outcome_blindness"),
        requires_live_competitor=True,
    ),
    "O31_observation_accumulation_calibration": _contract(
        ...
        ("same_source_copy_no_gain", "independent_feature_gain", "order_swap"),
    ),
    "O32_role_graph_critical_edge": _contract(
        ...
        ("necessary_edge_reversal_changes_result", "redundant_edge_no_effect", "name_or_order_swap"),
    ),
    "O33_cross_modal_support_boundary": _contract(
        ...
        ("misaligned_sources_cannot_combine", "non_observing_source_cannot_strengthen", "name_or_order_swap"),
        requires_live_competitor=True,
    ),
}
